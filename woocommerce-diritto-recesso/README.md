...
Le email vengono inviate tramite la funzione standard `wp_mail()` di WordPress, in formato HTML. L'indirizzo del mittente e quello dell'amministratore corrispondono a quelli configurati in **Impostazioni → Generali** di WordPress.
